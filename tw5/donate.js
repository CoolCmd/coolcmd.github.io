...
function ЗапретитьИзменениеАдресаСсылок()
// Коварный Google Translate меняет ссылки, чтобы переводить страницы, на которые они указывают. В том числе
// меняются ссылки, ведущие на другие сайты, которые уже переведены на другие языки, например PayPal. Я не
// знаю, как перевести только одну страницу, не трогая ссылки.
{
...
ЗапретитьИзменениеАдресаСсылок();
